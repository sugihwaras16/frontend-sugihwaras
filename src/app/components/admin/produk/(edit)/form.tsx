...
import {GetProductPayload, updateProduk} from "@/app/(public)/(main)/admin/produk/edit/[id]/action"
...
const FormProduk = ({ data, id }: { data: GetProductPayload, id: string }) => {
    ...
    const form = useFormik<FormValue>({
        ...
        initialValues: {
            ...
            size: data.sizeProduct.map((e) => ({
                size: e.size.toString(),
                price: Number(e.harga.toString())
            })),
            tiktokPath: data.tiktokPath ?? '',
            tokopediaPath: data.tokopediaPath ?? '',
            category: data.categoryProduct[0].id_category
        },
        onSubmit: async (e) => {
            console.log(e)
            try{
                await updateProduk(e, id)
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="lg:p-14 max-lg:p-5 w-full justify-center lg:m-10 max-md:m-5 rounded-xl bg-white">
                <Link href="/admin/produk" className="btn bg-white">Kembali</Link>
                <h1 className="py-6 text-black font-bold text-xl">Update Produk</h1>
                    ...
                    {values.size.map((_, index) => (
                        <div key={index} className="grid lg:grid-cols-2">
                            <label key={index} className="form-control w-full max-w-xs mb-4">
                                ...
                                <input type="text" placeholder="Ukuran Produk" value={values.size[index].size} className="input input-bordered w-full max-w-xs" name={`size[${index}].size`} onChange={handleChange} />
                            </label>
                            ...
                            <label key={index} className="form-control w-full max-w-xs mb-4">
                                ...
                                <input type="number" placeholder="Ukuran Produk" value={values.size[index].price} className="input input-bordered w-full max-w-xs" name={`size[${index}].price`} onChange={handleChange} />
                            </label>
                        </div>
                    ))}
                ...
                <div className="grid lg:grid-cols-2 gap-4">
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Produk" value={values.title} className="input input-bordered w-full max-w-xs" name="title" onChange={handleChange} />
                        </label>
                        {
                    ...
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="1-5" value={values.rating} className="input input-bordered w-full max-w-xs" name="rating" onChange={handleChange} />
                        </label>
                        {
                    ...
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Deskripsi" value={values.deskripsi} className="input input-bordered w-full max-w-xs" name="deskripsi" onChange={handleChange} />
                        </label>
                        {
                    ...
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Tokopedia" value={values.tokopediaPath} className="input input-bordered w-full max-w-xs" name="tokopediaPath" onChange={handleChange} />
                        </label>
                        {
                    ...
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Shopee" value={values.shopeePath} className="input input-bordered w-full max-w-xs" name="shopeePath" onChange={handleChange} />
                        </label>
                        {
                    ...
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Lazada" value={values.lazadaPath} className="input input-bordered w-full max-w-xs" name="lazadaPath" onChange={handleChange} />
                        </label>
                        {
                    ...
                    <div>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Tiktok Shop" value={values.tiktokPath} className="input input-bordered w-full max-w-xs" name="tiktokPath" onChange={handleChange} />
                        </label>
                        {
